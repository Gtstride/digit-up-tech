				...
				<div className='container'>
					<div className='row'>
						<div className='wow zoomIn col-xs-12 text-center p-padding'>
							<h1 className='section-title'>satisfied clients</h1>
						</div>
					</div>
					<div className='row'>
								...
								>
									...
									<div className='carousel-inner' role='listbox'>
										<div className='item active text-center'>
											...
											<p>
												“Perfection is achieved, not when there’s nothing more to add, but
												when theres is nothing left to take away.Laboriosam quae qui dolorem
												quasi molestias illo tempore optio amet, tempora deleniti. Magnam,
												distinctio!”
											</p>
										...
										<div className='item text-center'>
											...
											<p>
												...
												deserunt, fugit animi doloribus. Tempore, laboriosam. Laboriosam
												quae qui dolorem quasi molestias illo tempore optio amet, tempora
												deleniti. Magnam, distinctio!
											</p>
											<span className='pull-right'> FlexBoxConsult</span>
										</div>
										{/* item text-center */}
									</div>
									{/* carousel-inner */}
